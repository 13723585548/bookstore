...
<html>
  ...
  <body>
	<div class="divContent">
		...
		<span class="spanOid">编号：${order.id }</span>
	</div>
	<form action="<c:url value='/payment.action'/>" method="post" id="payment" target="_top">		
		...
		<div class="divBank">
			...
			<div style="margin: 40px;">
				<a href="javascript:void $('#payment').submit();" class="linkNext">下一步</a>
			</div>
		</div>
	</form>
</body>
