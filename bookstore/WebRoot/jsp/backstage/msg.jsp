	...
	<div class="divBody">
		...
		<div class="divContent">
			<div style="margin: 20px;">
				...
				<br /> <br /> <br /> <br /> 
				<c:choose>
					<c:when test="${btn eq 'del' }">
						<span style="margin-left: 50px;"><input type="button" value="返回" onclick="history.go(-2)" /></span>
					</c:when>
					<c:otherwise>
						<span style="margin-left: 50px;"><input type="button" value="返回" onclick="history.go(-1)" /></span>
					</c:otherwise>
				</c:choose>
